...
{
  CvFileStorage* fs = cvOpenFileStorage("/home/ahmed/RobotinoCV/config/FrameDifferenceBGS.xml", 0, CV_STORAGE_WRITE);
...
{
  CvFileStorage* fs = cvOpenFileStorage("/home/ahmed/RobotinoCV/config/FrameDifferenceBGS.xml", 0, CV_STORAGE_READ);
