...
/** Global variables */
String robotino_cascade_name = "/home/festo/ClionProjects/RobotinoCV/Cascade trials/datapuck2/cascade.xml";
...
void detectAndDisplay( Mat frame )
{
    ...
    //-- Detect faces
    robotino_cascade.detectMultiScale(frame,robotinos,1.9,40,0);
